...
export default function Dashboard() {
  return (
    <div id="dashboard-container" className="mt-4">
      ...
      <PageHeader
        title="Dashboard"
        breadcrumb="Dashboard / Customer / Order / Service"
      >
        <button className="bg-hijau text-white px-4 py-2 rounded-lg hover:opacity-90 transition">
          Add Data
        </button>
      </PageHeader>
      ...
      <div className="mt-6 px-4">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-2xl font-bold mb-2">Dessert Special Offer</h2>
